    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-gray-500">Active Legislators</CardTitle>
          ...
          <Card className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-gray-500">Compliance Deadlines</CardTitle>
          ...
          <Card className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-gray-500">Upcoming Hearings</CardTitle>
              <Clock className="h-4 w-4 text-gray-500" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-gray-900">0</div>
          ...
          <Card className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center p-3 hover:bg-gray-50 rounded-lg cursor-pointer transition-all duration-200">
                ...
                <span className="text-gray-600">My Bills</span>
              </div>
              <div className="flex items-center p-3 hover:bg-gray-50 rounded-lg cursor-pointer transition-all duration-200">
                <Users className="h-5 w-5 text-gray-500 mr-3" />
                <span className="text-gray-600">Search Legislators</span>
              </div>
              <div className="flex items-center p-3 hover:bg-gray-50 rounded-lg cursor-pointer transition-all duration-200">
                <FileText className="h-5 w-5 text-gray-500 mr-3" />
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center p-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-600">No bills tracked yet</p>
              ...
              <div className="flex items-center p-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-600">No legislators loaded</p>
              ...
              <div className="flex items-center p-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-600">System ready for sync</p>
